    ...
    <div className="bg-white text-black min-h-screen">
          ...
          <nav>
            <ul className="flex space-x-6">
              ...
              <li>
                <Link
                  to="#for-candidates"
                  onClick={() => handleScrollToSection("for-candidates")}
                  className="hover:text-gray-300"
                >
                  Cho ứng viên
                </Link>
              ...
              <li>
                <Link
                  to="#for-employers"
                  onClick={() => handleScrollToSection("for-employers")}
                  className="hover:text-gray-300"
                >
                  Cho nhà tuyển dụng
                </Link>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <p className="text-xl mb-8">
              HireDev - Nền tảng tuyển dụng hàng đầu cho ngành công nghệ, kết
              nối ứng viên tài năng với các công ty hàng đầu.
            </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center">
                  <CheckCircle className="w-6 h-6 mr-2 text-green-500" />
                  <span>
                    Theo dõi trạng thái ứng tuyển trong thời gian thực
                  </span>
                </li>
              </ul>
              <div className="mt-8">
                <ButtonComponent>
                  <div>Tạo hồ sơ ngay</div>
                </ButtonComponent>
              </div>
            </div>
            <div className="mt-8 md:mt-0">
              <Image
                src={CandidateDashboard}
            ...
            <div className="order-1 md:order-2">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center">
                  <CheckCircle className="w-6 h-6 mr-2 text-green-500" />
                  <span>
                    Sử dụng AI để lọc và đề xuất ứng viên phù hợp nhất
                  </span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-6 h-6 mr-2 text-green-500" />
                  <span>
                    Quản lý quy trình tuyển dụng với dashboard trực quan
                  </span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="w-6 h-6 mr-2 text-green-500" />
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <TestimonialCard
              ...
              avatar="src/assets/avatars/customer_3.jpg"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8">
            Cho dù bạn đang tìm kiếm cơ hội mới hay muốn tuyển dụng nhân tài,
            HireDev luôn sẵn sàng hỗ trợ bạn.
          </p>
