...
const PopularCategory = ()=>{
    return (
        <div className="px-5 md:px-primary h-[500px]">
            ...
            <div className="h-2/3 flex justify-between items-center flex-wrap ">
                {popularCategorys.map((item,idx)=>{
                    return (
                        <div className="w-[300px] h-[116px] rounded-lg  flex flex-wrap items-center gap-5 hover:bg-white hover:shadow-custom  cursor-pointer">
