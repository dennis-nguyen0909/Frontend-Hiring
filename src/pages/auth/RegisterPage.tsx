        ...
        return (
            <div className="w-[500px]">
                ...
                <div>
                    ...
                    <div className="mt-2">
                    <span className="text-gray-500 text-1xl">Already have account?</span><span onClick={handleNextRegister}  className="text-blue-500 cursor-pointer "> Log In</span>
                    </div>
                </div>
                <div>
                <Select
                ...
                <div className="flex flex-col gap-5 mt-5">
                    ...
                    size="large"
                            ...
                            iconRender={(visible) => (!visible ? <EyeFilled /> : <EyeInvisibleOutlined />)}
                        />
                        <Checkbox onChange={onChange}>I've read and agree with your <span className="text-blue-500"> Terms of Services</span></Checkbox>
                </div>
                <div className="flex flex-col gap-5 mt-5 justify-center items-center">
                    <Button className="bg-primaryBlue text-white text-bold w-full" size="large"  style={{backgroundColor:"#0f65cc"}}>Sign in  <ArrowRightOutlined  style={{fontSize:'18px',fontWeight:'bold'}} /></Button>
                </div>
