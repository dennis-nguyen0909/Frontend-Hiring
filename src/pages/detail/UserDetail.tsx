...
const UserDetail = () => {
  ...
  return (
    <div className="px-primary bg-[#f0f0f0] flex h-screen mt-10 py-2">
      <div className="w-2/3 bg-white h-fit p-6 shadow-md mr-[50px] rounded-2xl">
      ...
      <div className="w-1/4 bg-white h-auto rounded-2xl px-8 py-4 ">
