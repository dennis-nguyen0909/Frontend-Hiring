...
export default function DegreeTypeComponent() {
  ...
  const onFinish = async (values: Level) => {
    ...
    const res = await DEGREE_TYPE_API.create({ name, description, user_id: userDetail?._id,key}, userDetail.access_token)
    if (res.data) {
  ...
  const handleUpdate = async (values: any) => {
    const res = await DEGREE_TYPE_API.update(selectedSkill?._id, values, userDetail.access_token)
    if (res.data) {
      notification.success({
        message: "Thông báo",
  ...
  const handleDelete = async (record: any) => {
    const res = await DEGREE_TYPE_API.deleteManyLevels([record._id], userDetail.access_token)
    if (res.data) {
      notification.success({
        message: "Thông báo",
